M291 P"Please wait while the nozzle is being heated up ..." R"Loading PLA" T0
M568 R150 S210    ; set standby and active temp for current tool
M568 A2           ; set current tool to active state
M116              ; wait for the temperatures to be reached

M291 P"Feeding filament ..." R"Loading PLA" T0
...
M291 P"Finished loading filament." R"Loading PLA" T10