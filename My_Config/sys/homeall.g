...
G1 H1 X-315 Y305 F1800 ; move quickly to X and Y axis endstop and stop there (first pass)
...
G1 H1 X-315 Y305 F360  ; move slowly to X and Y axis endstop once more (second pass)
